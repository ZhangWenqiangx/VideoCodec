...
import com.example.video.camera.compress.CompressKt;
...
//        new Compress(srcPath,destPath,VideoController.COMPRESS_QUALITY_LOW,listener);
     ...
     *  @dec  开启线程,进行压缩
     *  @author tangxiaopeng
     *  @date  2018/10/18 14:45  AsyncTask<String, Float, Boolean>
     */
